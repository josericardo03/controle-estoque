...
const menuItems = [
  ...
  {
    title: "Vendas",
    description: "PDV e controle de vendas",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {menuItems.map((item) => (
            ...
            >
              <div className="p-6">
                <div
                  className={`${item.color} rounded-lg p-3 inline-block text-white mb-4`}
                >
                  {item.icon}
                </div>
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="flex-shrink-0">
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.171-.879-1.171-2.303 0-3.182C10.536 7.719 11.768 7.5 12 7.5c1.277 0 2.555.22 3.536.659"
                  />
                </svg>
              </div>
              <div className="ml-4">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="mt-1 text-2xl font-semibold text-blue-600">150</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h4 className="text-lg font-medium text-gray-900">Clientes</h4>
